...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FUNCTION] = LAYOUT( \
		KC_LGUI, KC_F1, KC_F2 , KC_F3 , KC_F4 , XXXXXXX,     D_QWRTY, D_DVRAK, D_COLEM, D_C_DH , D_WISH, D_WORKM, \
...
const char *read_layout_state(void) {
	...
	else if ( default_layer_state & 1UL << _WISH) snprintf(layout_state_str, sizeof(layout_state_str), "Layout: WISH");
